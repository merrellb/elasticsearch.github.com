...
** uncomment the line starting <code>ULIMIT_N</code> and change it to: <code>  ULIMIT_N=32000</code>
...
* Edit <code>/etc/security/limits.conf</code> and add these lines (this increases the number of files that the <code>elasticsearch</code> user can open, see "Raising nofile limits":/tutorials/2011/04/06/too-many-open-files.html if you have any problem here):
